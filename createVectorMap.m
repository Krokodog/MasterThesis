    ...
    for i = 1:cfg.searchSwarmSize
        if(cfg.searchSwarm(i,1)>=0 &&cfg.searchSwarm(i,1)<=20&&cfg.searchSwarm(i,2)>=0 &&cfg.searchSwarm(i,2)<=20)
            if(vMap(round(cfg.searchSwarm(i,1))+1,round(cfg.searchSwarm(i,2))+1)==0)
                vMap(round(cfg.searchSwarm(i,1)+1),round(cfg.searchSwarm(i,2)+1),1)= cfg.searchSwarm(i,3)-cfg.searchSwarm(i,5);
                vMap(round(cfg.searchSwarm(i,1)+1),round(cfg.searchSwarm(i,2)+1),2)= cfg.searchSwarm(i,4)-cfg.searchSwarm(i,6);
            end
        end
